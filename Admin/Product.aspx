<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="hungryHub.Admin.Product" %>
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                                ...
                                                                SetFocusOnError="true" ControlToValidate="txtPrice"
                                                                ValidationExpresssion="^\d{0,8}(\.\d{1,4})?$">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                                ...
                                                                ForeColor="Red" Display="Dynamic"
                                                                SetFocusOnError="true" ControlToValidate="txtQuantity"
                                                                ValidationExpresssion="^([1-9]\d*|0)$"></asp:RegularExpressionValidator>
                                                        </asp:RequiredFieldValidator>
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server"
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img width="40" src="<%# hungryHub.Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="">
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CssClas="badge badge-primary"
                                                                        CommandArgument='<%# Eval("CategoryId") %>' CommandName="edit">
                                                                     <i class="ti-pencil"></i>

                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete"
                                                                        CommandName="delete" CssClass="badge bg-danger" CommandArgument='<%# Eval("CategoryId") %>'
